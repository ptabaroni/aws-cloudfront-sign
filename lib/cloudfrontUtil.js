...
//var CustomPolicy = require('./CustomPolicy');
...
function getSignedUrl(cfUrl, params) {
  ...
  /*IF to find whether it's Canned or Custom based on params values
  var policy = new CannedPolicy(cfUrl, expireTime);
  or
  var policy = new CustomPolicy(cfUrl, expireTime, IP, etc...);
  Set flag custom = true
  */
